...
# ─────────────────────────────────────────────
#  STEP 2 — SPLIT
#  NOTE: XGBoost handles missing values natively
...
fig.suptitle("XGBoost — ZT Prediction", fontsize=14, fontweight="bold")

# Actual vs Predicted
axes[0].scatter(y_test, y_pred, alpha=0.3, color="#E07B39",
...
bar_colors   = ["#E07B39", "#DD8452", "#55A868"]
...
axes[2].barh(top15.index[::-1], top15.values[::-1], color="#E07B39", alpha=0.85)
axes[2].set_xlabel("Importance", fontsize=11)
axes[2].set_title("Top 15 Feature Importances", fontsize=11)

plt.tight_layout()
plt.savefig("/home/sudarshan/Documents/INFORMATICS/ML/xgboost_ZT_results.png", dpi=150, bbox_inches="tight")
print("\nPlot saved -> xgboost_ZT_results.png")
plt.show()